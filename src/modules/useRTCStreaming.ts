...
import type { RTCSignalMessage, RTCSignalType } from '../types/realtime';

type ConnectionState = 'disconnected' | 'connecting' | 'connected';

type OutboundSignal = Omit<RTCSignalMessage, 'type'>;
...
export function useRTCStreaming(
  onSignal?: (signal: OutboundSignal) => void,
  ...
  const emitSignal = useCallback((signal: OutboundSignal) => {
...
export type { ConnectionState, RTCSignalType };
